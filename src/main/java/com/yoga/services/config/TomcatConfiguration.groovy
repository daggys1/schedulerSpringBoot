...
import static com.yoga.services.util.SpringConfigurationUtils.intFromEnvironmentOrIllegalArgumentException
import static com.yoga.services.util.SpringConfigurationUtils.intFromEnvironmentOrNull
